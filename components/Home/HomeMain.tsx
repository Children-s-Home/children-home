        ...
        return(
            <div className="home-content">
                <div className="home-words">
                    <h3><span className="black">Give back</span><span className="orange"> to your community.</span><br/>
                    <span className="orange"> Find a</span><span className="black"> children's home </span><span className="orange">near<br/>you.</span></h3>
